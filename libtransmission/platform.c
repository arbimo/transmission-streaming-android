...
getHomeDir( void )
{
    ...
    if( !home )
    {
        home = tr_strdup( getenv( "TRANSMISSION_HOME" ) );
        ...
        if( !home )
        {
            ...
            *appdata = '\0';
            ...
            //TODO : Save everything on the sdcard, will need some extra config to store config in /data 
            home = tr_strdup("/mnt/sdcard");
#else
