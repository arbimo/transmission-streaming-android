...
tr_arePiecesSorted( const Torrent * t )
{
    return t->arePiecesSorted;
}

static inline void
tr_setPiecesSorted( Torrent * t, const tr_bool areSorted )
{
